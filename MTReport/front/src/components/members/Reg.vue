...
<div class="container ">
 ...
 <form class="form-signin rounded border d-flex flex-column align-items-center" >
  ...
  <button class="btn btn-sm btn-dark btn-block rounded" type="submit" @click="regSubmit">Signin</button>
  <button class="btn btn-sm btn-dark btn-block rounded" type="reset" @reset="onReset"> Reset</button>
  <div class="row">
